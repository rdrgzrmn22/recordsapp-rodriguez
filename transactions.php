...
$t_results = mysqli_fetch_all(mysqli_query($conn, $sqlstatement), MYSQLI_ASSOC);
                ...
                <div class="container-fluid">
                    <div class="section">
                        ...
                        <table style="width: 100%; height: 100%;">
                            ...
                            <tbody>
                                <?php foreach ($t_results as $row1) : ?>
                                    <tr>

                                        <td><?php echo $row1['date_log']; ?></td>
                                        <td><?php echo $row1['doc_code']; ?></td>
